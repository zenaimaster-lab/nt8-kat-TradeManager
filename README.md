...
**Current Version**: `v0.77` (Released: `2026-07-28`)
...
- **Draggable HUD (default InChart / optional ChartTrader)**: Captures drag on the HUD border itself in both modes, keeps at least 40px visible, starts 80px from chart left edge, and preserves user position across watchdog re-attachment.
