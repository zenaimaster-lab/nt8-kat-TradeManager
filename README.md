...
**Current Version**: `v0.50` (Released: `2026-07-25`)
...
- **Floating ChartTrader HUD Overlay**: High Z-Index (`99999`) floating overlay anchored to bottom of ChartTrader container. Does not get clipped or pushed out of view when shrinking chart window height.
