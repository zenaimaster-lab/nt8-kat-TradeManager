...
## Corpus Check
- 20 files · ~13,389 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 177 nodes · 200 edges · 20 communities (10 shown, 10 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dbb3b28d`
...
4. `KatTradeCalculator` - 12 edges
5. `StressAndEdgeCaseTests` - 12 edges
