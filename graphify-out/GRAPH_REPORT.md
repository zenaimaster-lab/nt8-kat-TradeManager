...
## Corpus Check
- 26 files · ~29,922 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 350 nodes · 510 edges · 26 communities (11 shown, 15 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 63 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `91e45f3a`
...
3. `KatTradeManager` - 38 edges
4. `KatTradeManager` - 31 edges
5. `KatTradeCalculator` - 24 edges
...
- **Why does `KatTradeManager` connect `Community 1` to `Community 2`, `Community 4`?**
