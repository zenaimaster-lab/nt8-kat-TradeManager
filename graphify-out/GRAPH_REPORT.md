...
## Corpus Check
- 26 files · ~29,268 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 342 nodes · 496 edges · 26 communities (11 shown, 15 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 62 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7ebe015f`
...
Cohesion: 0.09
Nodes (9): bool, Brush, DispatcherTimer, double, EMA, KatTradeManager, NinjaTrader.NinjaScript.Indicators, TextBlock (+1 more)
...
## Knowledge Gaps
- **33 isolated node(s):** `NinjaTrader.NinjaScript.Indicators`, `Account`, `Grid`, `Border`, `StackPanel` (+28 more)
