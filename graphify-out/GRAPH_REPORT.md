...
## Corpus Check
- 26 files · ~24,619 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 305 nodes · 427 edges · 26 communities (11 shown, 15 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 53 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0f2e0979`
...
2. `KatCalculatorGapTests` - 29 edges
...
- **Why does `KatTradeManager` connect `Community 0` to `Community 1`, `Community 3`, `Community 5`?**
