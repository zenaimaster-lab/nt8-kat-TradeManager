...
## Corpus Check
- 26 files · ~30,642 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 359 nodes · 526 edges · 26 communities (11 shown, 15 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 63 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0eb195e5`
...
- **Why does `KatTradeManager` connect `Community 1` to `Community 3`, `Community 4`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `string` connect `Community 4` to `Community 1`, `Community 2`, `Community 3`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `KatTradeManager` connect `Community 2` to `Community 1`, `Community 3`, `Community 4`?**
