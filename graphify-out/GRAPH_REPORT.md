...
## Corpus Check
- 33 files · ~42,003 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 514 nodes · 868 edges · 33 communities (16 shown, 17 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 93 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `db25edca`
...
Cohesion: 0.08
Nodes (4): Queue, KatTradeManager, NinjaTrader.NinjaScript.Indicators, KatTradeManager

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (11): Brush, Button, Canvas, IInputElement, Point, SolidColorBrush, KatTradeManager, NinjaTrader.NinjaScript.Indicators (+3 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (17): Account, AtmLevels, Border, ComboBox, DispatcherTimer, EMA, Grid, Indicator (+9 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (11): AccountOperationType, Action, bool, List, AccountOperationRequest, NinjaTrader.NinjaScript.Indicators, AtmTemplateNameConverter, KatTradeManager (+3 more)

### Community 9 - "Community 9"
Cohesion: 0.19
Nodes (6): DateTime, double, OrderType, FreezeExitCapture, KatTradeManager, NinjaTrader.NinjaScript.Indicators
...
## Knowledge Gaps
- **45 isolated node(s):** `NinjaTrader.NinjaScript.Indicators`, `Account`, `Grid`, `Border`, `StackPanel` (+40 more)
...
- **Why does `KatTradeManager` connect `Community 0` to `Community 9`, `Community 2`, `Community 18`, `Community 6`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `string` connect `Community 6` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 9`?**
