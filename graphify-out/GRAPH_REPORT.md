...
## Corpus Check
- 26 files · ~32,016 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 375 nodes · 565 edges · 26 communities (11 shown, 15 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 66 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f6b5b1e1`
...
- **Why does `KatTradeManager` connect `Community 3` to `Community 0`, `Community 2`, `Community 4`?**
