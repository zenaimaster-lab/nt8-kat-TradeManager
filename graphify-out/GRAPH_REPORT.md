...
## Corpus Check
- 21 files · ~16,473 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 200 nodes · 230 edges · 21 communities (9 shown, 12 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `990a6e1c`
...
3. `KatTradeCalculator` - 16 edges
4. `KatRenkoAndHalfCandleTests` - 14 edges
5. `KatTradeCalculatorTests` - 13 edges
6. `StressAndEdgeCaseTests` - 12 edges
7. `KatEmaPlaceAndAngleTests` - 11 edges
8. `KatTradeManager` - 10 edges
...
## Knowledge Gaps
- **29 isolated node(s):** `NinjaTrader.NinjaScript.Indicators`, `Account`, `Grid`, `Border`, `StackPanel` (+24 more)
...
- **Why does `KatTradeManager` connect `Community 0` to `Community 2`, `Community 3`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `string` connect `Community 2` to `Community 0`?**
