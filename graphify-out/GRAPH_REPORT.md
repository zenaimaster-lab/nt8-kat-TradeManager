...
## Corpus Check
- 26 files · ~32,429 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 379 nodes · 575 edges · 26 communities (11 shown, 15 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 66 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c1c03404`
...
1. `KatTradeManager` - 54 edges
2. `KatTradeManager` - 49 edges
3. `KatCalculatorGapTests` - 44 edges
4. `KatTradeManager` - 40 edges
...
Cohesion: 0.1
Nodes (17): Account, AtmLevels, Border, ComboBox, DateTime, Grid, Indicator, int (+9 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (12): bool, Brush, Canvas, DispatcherTimer, double, EMA, IInputElement, Point (+4 more)
...
## Knowledge Gaps
- **35 isolated node(s):** `NinjaTrader.NinjaScript.Indicators`, `Account`, `Grid`, `Border`, `StackPanel` (+30 more)
...
- **Why does `KatTradeManager` connect `Community 0` to `Community 2`, `Community 3`, `Community 4`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `KatTradeManager` connect `Community 2` to `Community 3`, `Community 4`?**
