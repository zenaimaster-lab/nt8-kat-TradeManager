# Graph Report - nt8-kat-TradeManager  (2026-07-29)

## Corpus Check
- 27 files · ~35,498 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 425 nodes · 693 edges · 28 communities (11 shown, 17 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6b469c32`
...
- **Why does `string` connect `Community 2` to `Community 0`, `Community 3`, `Community 5`?**
